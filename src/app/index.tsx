  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: colors.bg }}>
      <View style={{ flex: 1, paddingHorizontal: 28, alignItems: 'center' }}>
        <Text style={{ fontSize: 30, fontWeight: '800', color: colors.primary, marginTop: spacing.sm, letterSpacing: -0.5 }}>Naizz</Text>
        ...
        <View style={{ height: 300, alignSelf: 'stretch', alignItems: 'center', justifyContent: 'center' }}>
          <View style={{ width: 230, height: 230, borderRadius: 115, backgroundColor: 'rgba(21,115,166,0.07)', alignItems: 'center', justifyContent: 'center' }}>
            <View style={{ width: 175, height: 175, borderRadius: 88, backgroundColor: 'rgba(21,115,166,0.11)', alignItems: 'center', justifyContent: 'center' }}>
              <View style={{ width: 120, height: 120, borderRadius: 60, backgroundColor: colors.primary, alignItems: 'center', justifyContent: 'center', ...shadow.lg }}>
        ...
        <Text style={[type.hero, { color: colors.ink, textAlign: 'center', marginTop: spacing.sm, fontSize: 40, lineHeight: 46 }]}>
          Say it out <Text style={{ color: colors.primary }}>loud.</Text>
        </Text>
        <Text style={[type.callout, { color: colors.textSec, textAlign: 'center', lineHeight: 23, marginTop: spacing.lg, paddingHorizontal: 8 }]}>
          A cozy corner of the internet where every post is your voice. No typing, no pressure — just talk, listen, connect.
        </Text>

        <View style={{ flex: 1 }} />

        <View style={{ width: '100%', gap: spacing.md, paddingBottom: spacing.md }}>
